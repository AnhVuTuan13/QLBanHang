...
namespace BUS_QLBanHang.BUS_QL
{
    public class BUS_NhapHang
    {
        ...
        public void Add(String Ma, String MaNCC, String MaNhanVien, String NgayDat, String TongTien, List<C_CTHoaDB> DS)
        {
            String sqladdDH = "INSERT INTO HoaDonN Values(N'{0}',N'{1}',N'{2}',N'{3}',{4})";
            sqladdDH = string.Format(sqladdDH, Ma, MaNCC, MaNhanVien, NgayDat, TongTien);
            dal.ExcuteNonQuery(sqladdDH);

            String sqlChiTiet = "INSERT INTO CTHoaDonN Values(N'{0}',N'{1}',{2},{3})";
