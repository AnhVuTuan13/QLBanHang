...
namespace GUI_QLBanHang
{
    public partial class F_NhapHang : Form
    {
        ...
        {
            string lastId = autoID.GetLastID("HoaDonN", "MaHDN");
            string nextID = autoID.NextID(lastId, "HDN");
            txtMa.Text = nextID;
        }
        ...
        private void btadd_Click(object sender, EventArgs e)
        {
            ...
            {
                bus.Add(txtMa.Text, CbNCC.SelectedValue.ToString(), cbNhanVien.SelectedValue.ToString(), dateNgayDat.Value.ToString("MM/dd/yyyy"), txtTongTien.Text, Ds);
                loadIDNext();
                loadcb();
                Ds.Clear();
                loadDGV();
