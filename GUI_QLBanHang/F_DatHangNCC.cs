...
{
    public partial class F_DatHangNCC : Form
    {
        public F_DatHangNCC()
        {
            InitializeComponent();
        }
        BUS_DonDHNCC bus = new BUS_DonDHNCC();
        ...
        private void loadcb()
        {
            ...
            CbNCC.DataSource = bus.loadcbNCC();
        ...
        {
            string lastId = autoID.GetLastID("DonDHNCC", "MaDonDHNCC");
            string nextID = autoID.NextID(lastId, "DHNCC");
            txtMa.Text = nextID;
        }

        private void F_DatHangNCC_Load(object sender, EventArgs e)
        {
            loadcb();
            loadDVT(cbSanPham.SelectedValue.ToString());
            loadIDNext();
        ...
        private void btadd_Click(object sender, EventArgs e)
        {
            ...
            {
                bus.Add(txtMa.Text,CbNCC.SelectedValue.ToString(),cbNhanVien.SelectedValue.ToString(), dateNgayDat.Value.ToString("MM/dd/yyyy"), Ds);
                loadIDNext();
                loadcb();
                Ds.Clear();
                loadDGV();
