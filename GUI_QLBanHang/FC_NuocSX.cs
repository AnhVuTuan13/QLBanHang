...
{
    public partial class FC_NuocSX : Form
    {
        C_AutoID autoID = new C_AutoID();
        BUS_FC_NuocSX busfc = new BUS_FC_NuocSX();
        public FC_NuocSX()
        {
            InitializeComponent();
        }
        ...
        {
            string lastId = autoID.GetLastID("NuocSX", "MaNuocSX");
            string nextID = autoID.NextID(lastId, "NSX");
            txtMa.Text = nextID;
        }
        ...
        private void btOK_Click(object sender, EventArgs e)
        {
            ...
            {
                if (lbChange.Text == "Thêm Nước Sản Xuất")
                {
        ...
        private void FC_NuocSX_Load(object sender, EventArgs e)
        {
